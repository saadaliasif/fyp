...
class Ui_dashboard(object):
    def setupUi(self, dashboard):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/icons/person-circle-outline.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/add-circle-outline.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.adddoctor_pushButton.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/remove-circle-outline.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/person-add-outline.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.addpatient_pushButton.setIcon(icon3)
