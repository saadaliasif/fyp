...
class Ui_signuppage(object):
    def setupUi(self, signuppage):
        ...
        self.signup_label.setGeometry(QRect(460, 10, 141, 61))
        font1 = QFont()
        font1.setFamilies([u"MV Boli"])
        font1.setPointSize(24)
        self.signup_label.setFont(font1)
        self.formLayoutWidget = QWidget(signuppage)
        self.formLayoutWidget.setObjectName(u"formLayoutWidget")
        self.formLayoutWidget.setGeometry(QRect(90, 80, 891, 500))
        ...
        self.first_name_label = QLabel(self.formLayoutWidget)
        ...
        self.first_name_lineEdit = QLineEdit(self.formLayoutWidget)
        ...
        self.last_name_label = QLabel(self.formLayoutWidget)
        ...
        self.last_name_lineEdit = QLineEdit(self.formLayoutWidget)
        ...
        self.education_lineEdit = QLineEdit(self.formLayoutWidget)
        ...
        self.email_lineEdit = QLineEdit(self.formLayoutWidget)
        ...
        self.username_lineEdit = QLineEdit(self.formLayoutWidget)
        ...
        self.password_lineEdit = QLineEdit(self.formLayoutWidget)
        self.password_lineEdit.setObjectName(u"password_lineEdit")

        self.formLayout.setWidget(11, QFormLayout.FieldRole, self.password_lineEdit)

        self.confirm_password_lineEdit = QLineEdit(self.formLayoutWidget)
        ...
        self.confirm_password_label = QLabel(self.formLayoutWidget)
        ...
        self.postal_code_lineEdit = QLineEdit(self.formLayoutWidget)
        ...
        self.postal_code_label = QLabel(self.formLayoutWidget)
        ...
        self.signup_pushButton.setGeometry(QRect(450, 600, 191, 62))
